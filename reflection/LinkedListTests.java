 ...
 * Class: CS 231 B
 * Project: Project 3
 * Description: This program tests all the linkedlist methods in the linkedlist classes
*/
...
public class LinkedListTests {
    ...
    // case 12: testing push, peek and poll
{
    // setup
    LinkedList<Integer> ll = new LinkedList<Integer>();
    ...
    // Verify peek
    System.out.println(ll.peek() + " == 3");
    assert ll.peek() == 3 : "Error in LinkedList::peek()";
    ...
    assert val1 == 3 : "Error in LinkedList::pop()";
    assert val2 == 2 : "Error in LinkedList::pop()";
    assert val3 == 1 : "Error in LinkedList::pop()";
